...
class CursorWrapper:
    ...
    def _timed_call(self, method: str, args: Tuple[Any, ...], kwargs: Dict[str, Any]) -> Any: ...
    def quote(self, operation: str, parameters: dict[str, Any]) -> str: ...
    def preformat(self, sql: str, params: dict[str, Any]): ...
    def execute(self, operation: str, parameters=list, log_errors: bool = True): ...
...
class QueryProcessor:
    ...
    def __init__(self,
                 ...
                 joins: Optional[Iterable[str]] = None,
                 clauses: Optional[Iterable[str]] = None,
                 values: Optional[dict[str, Any]] = None,
                 transform: Optional[Callable] = None,
                 opts: Optional[_QueryOpts] = None,
                 enable_group: bool = False,
                 order_map: Optional[Dict] = None) -> None:
        ...
...
class BulkUpdateProcessor(object):
    ...
    def get_keys(self) -> tuple[set, list]: ...
    def __repr__(self) -> str: ...
    def execute(self) -> int: ...
