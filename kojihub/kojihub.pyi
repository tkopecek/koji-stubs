from typing import Any, Optional, Union, overload, Dict, Tuple, TypedDict, TypeAlias
...
# as an argument
_tagInfo: TypeAlias = Union[str, int]
# as return value
class _tagInfoReturned(TypedDict):
    id: int
    name: str
...
class Task:
    ...
    def verifyHost(self, host_id: Optional[int] = None) -> bool: ...
    def assertHost(self, host_id: int) -> None: ...
    def getOwner(self) -> int: ...
    def verifyOwner(self, user_id: Optional[int] = None) -> bool: ...
    def assertOwner(self, user_id: Optional[int] = None) -> None: ...
    def lock(
        self,
        host_id: int,
        newstate: str = 'OPEN',
    ...
    def setPriority(self, priority: int, recurse: bool = False) -> None: ...
...
def readInheritanceData(
        tag_id: int,
        event: Optional[int] = None) -> list[dict[str, Any]]:
    ...
...
def create_tag(
    name: str,
    parent: Optional[_tagInfo] = None,
    arches: Optional[str] = None,
    perm: Optional[Union[str, int]] = None,
    locked: bool = False,
...
def get_tag(
    ...
    blocked: bool = False) -> Optional[_tagInfoReturned]:
    ...
...
def policy_get_build_tags(
    data: Dict[str, Any],
    taginfo: Literal[False] = False
) -> List[Optional[str]]:
    """Get build tags from policy data

    :param data: Policy data
    :param taginfo: Return full tag info dicts instead of just names
    :returns: List of tag names (strings or None)
    """
    ...
...
def policy_get_build_tags(
    data: Dict[str, Any],
    taginfo: Literal[True]
) -> List[Optional[Dict[str, Any]]]:
    """Get build tags from policy data

    :param data: Policy data
    :param taginfo: Return full tag info dicts instead of just names
    :returns: List of tag info dicts (or None)
    """
    ...
...
def policy_get_build_tags(
    data: Dict[str, Any],
    taginfo: bool = False
) -> Union[List[Optional[str]], List[Optional[Dict[str, Any]]]]:
    """Get build tags from policy data

    :param data: Policy data
    :param taginfo: Return full tag info dicts instead of just names
    :returns: List of tag names or tag info dicts (may contain None)
    """
    ...
